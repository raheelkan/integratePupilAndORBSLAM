...
set( figure_all, 'Position', [0.01,0.2,0.7,0.8] );
set( figure_all, 'Units', oldUnits );

% models_fig = subplot('position',[0.05 0.1 0.05 0.8]);
im_fig = subplot('position',[0.05 0.55 0.425 0.4]);

near3D_fig = subplot('position',[0.575 0.55 0.375 0.4]);
view(-180,0);

near3D_fig2 = subplot('position',[0.05 0.1 0.425 0.4]);
view(0,-90);

near3D_fig3 = subplot('position',[0.575 0.1 0.375 0.4]);
view(-180,0);
